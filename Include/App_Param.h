...
#define I2C_Add_Voice 			0x11	 	//I2C语音语言选择存储地址,語音開關標誌位
#define I2C_Add_Unit 			0x12	 	//I2C单位选择存储地址
#if ET_FT !=1
#define I2C_Add_Emission 		0x14	 	//I2C人体发射率存储地址
#define I2C_Add_HumanRatio1 		0x15		//I2C人体系数存储地址
#if Func_Probecover
#define I2C_Add_HumanRatio2 		0x19		//I2C人体系数存储地址
...
#define Mem_EarAdd 				0x20		//I2C耳温记忆截止地址  //所有记忆温度起始地址
#if ET_FT !=1
...
/****************************************系数相关RAM定义****************************************/
#if ET_FT !=1
extern uint8 g_HumanRatio1;			//人体系数
#if Func_Probecover
extern uint8 g_HumanRatio2;			//人体系数
#endif
...
void Backdoor_Parameters_Write(void);
